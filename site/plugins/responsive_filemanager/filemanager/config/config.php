...
// Encrypt Function
	...
	$_SESSION['RF']["subfolder"] =  mc_decrypt($_SESSION['nomesession'], ENCRYPTION_KEY);			//define a pasta com o nome do usuário como root
	if ($_SESSION['idsession'] == 1)								//se for administrador, não define nenhuma pasta como root
	{
...
$config = array(
	...
	*/
	...
	|
	*/
	'upload_dir' => '/lcp/site/plugins/responsive_filemanager/uploads/',
	...
	*/
	 ...
	 *******************/
	'aviary_active'                           => false,
	'aviary_apiKey'                           => "3e61f7e972244d3cbab1f3eaeae90ed8",
	'aviary_secret'                           => "1be1df5b-09ff-4f55-92c1-59e06df29ae2",
